...
meta = SamplingMetadata(temp, False, False, top_p=topp, top_k=None, min_p=None, generators={}, max_num_logprobs=None, 
                        ...
                        logit_bias=[], allowed_token_ids_mask=None, prompt_token_ids=None,bad_words_token_ids=dict())
